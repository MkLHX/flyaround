...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'my_project', 'user' => 'mleh', 'password' => 'mleh', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7c77620251688312191f6a6dc5027a255839f223d7b243308779e3e486bd7f70');
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminGroups(array('un terme plus parlant' => array('label' => 'un terme plus parlant', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'on_top' => false, 'items' => array(0 => array('admin' => 'app.admin.terrain', 'label' => 'Terrain', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 1 => array('admin' => 'app.admin.flight', 'label' => 'Flight', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 2 => array('admin' => 'app.admin.planemodel', 'label' => 'PlaneModel', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 3 => array('admin' => 'app.admin.reservation', 'label' => 'Reservation', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 4 => array('admin' => 'app.admin.user', 'label' => 'User', 'route' => '', 'route_params' => array(), 'route_absolute' => true)))));
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5829cdfa7e27e9.63563517')), true);
